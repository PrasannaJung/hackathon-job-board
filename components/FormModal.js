  ...
  return (
    <div className='bg-gradient-to-r from-violet-500 to-fuchsia-500 z-20 fixed top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 px-3 py-6 w-1/3'>
      <form className='flex mx-auto flex-col w-3/4 '>
        ...
        <CloseButton onHide={props.onHide} classes={'absolute top-2 right-2 text-sm h-10 hover:cursor-pointer'} />
        ...
        <select name="pos" id="pos" className='text-black outline-none p-1 rounded-sm'>
        ...
        <button className={'mt-3 bg-gradient-to-r from-violet-700 to-fuchsia-900 mx-auto px-2 py-1 font-bold'} type="submit">
          Submit
        </button>
